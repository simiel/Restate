        ...
        <View className="relative w-full" style={{ height: windowHeight / 2 }}>
          {property?.gallery.length > 1 ? (
            <Swiper
              ...
              index={0}
            >
              {property?.gallery.map((item: any, index: string) => (
                <Image
                  key={index}
            ...
            <>
              ...
              />
              <Image
                source={images.whiteGradient as ImageSourcePropType}
        ...
        <View className="px-5 mt-7 flex gap-2">
          ...
          <View className="flex flex-row items-center mt-5">
            ...
            <View className="flex flex-row items-center justify-center bg-primary-100 rounded-full size-10 ml-7">
              <Image
                source={icons.bath as ImageSourcePropType}
                className="size-4"
              />
            </View>
            <Text className="text-black-300 text-sm font-rubik-medium ml-2">
            ...
            <View className="flex flex-row items-center justify-center bg-primary-100 rounded-full size-10 ml-7">
              <Image
                source={icons.area as ImageSourcePropType}
                className="size-4"
              />
            </View>
            <Text className="text-black-300 text-sm font-rubik-medium ml-2">
          ...
          <View className="w-full border-t border-primary-200 pt-7 mt-5">
            ...
            <View className="flex flex-row items-center justify-between mt-4">
              ...
              <View className="flex flex-row items-center gap-3">
                ...
                />
                <Image
                  source={icons.phone as ImageSourcePropType}
                  className="size-7"
                />
              </View>
            </View>
                    ...
                    >
                      <View className="size-14 bg-primary-100 rounded-full flex items-center justify-center">
                        <Image
                          source={
                            facility
                              ? (facility.icon as ImageSourcePropType)
                              : (icons.info as ImageSourcePropType)
                          }
                          className="size-6"
                        />
                      </View>
